...
int ps_send_usr_rq_pause_threads(
	...
	msg->type = USR_RQ_PAUSE_THREADS;
	msg->body.usr_rq_pause_threads.client = client;
...
int ps_send_usr_rq_get_async_errors(
	...
	msg->type = USR_RQ_GET_ASYNC_ERRORS;
	msg->body.usr_rq_get_async_errors.client = client;
